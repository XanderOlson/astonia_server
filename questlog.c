...
struct questlog questlog[]={
    {"Lydia's Potion",1,200,"James","Cameron",15000,QLF_REPEATABLE},         //0,
    {"Find the Spoon of Doom",2,200,"Gwendolyn","Cameron",75000,QLF_REPEATABLE},        //1,
    {"The Second Skull",3,200,"Gwendylon","Cameron",15000,QLF_REPEATABLE},      //2,
    {"The Third Skull",5,200,"Gwendylon","Cameron",30000,QLF_REPEATABLE},       //3,
    {"Kill the Foul Magician",6,200,"Gwendylon","Cameron",80000,QLF_REPEATABLE},    //4,
    {"Bear Hunt",6,200,"Yoakin","Cameron",60000,QLF_REPEATABLE},            //5,
    {"A Fool's Request",6,200,"Nook","Cameron",40000,0},                //6,
    {"Mages Gone Berserk",6,200,"Guiwynn","Cameron",80000,QLF_REPEATABLE},      //7,
    {"The Recipe for Happiness",7,200,"Guiwynn","Cameron",90000,QLF_REPEATABLE},   //8,
    {"Knightly Troubles",7,200,"Logain","Cameron",120000,QLF_REPEATABLE},      //9,
    {"Loisan's House",9,200,"Seymour","Aston",85000,0},                //10,
    {"The Silver Skull",10,200,"Seymour","Aston",100000,0},                //11,
    {"Find Loisan",11,200,"Seymour","Aston",150000,QLF_REPEATABLE},            //12,
    {"Jeepers Creepers",12,200,"Kelly","Aston",185000,QLF_REPEATABLE},         //13,
    {"Underground Park Shrines",15,200,"Kelly","Aston",0,0},             //14, special case: exp awarded in driver, 4500 exp total
    {"In Search of Clara",20,200,"Kelly","Aston",250000,0},                //15,
    {"The Astronomer's Notes",15,200,"Gerassimo","Aston",500000,QLF_REPEATABLE},   //16,
    {"The Unwanted Tenants",9,200,"Reskin","Cameron",125000,0},            //17,
    {"The Toughest Monster",20,200,"Sir Jones","Aston",750000,0},          //18,
    {"The Toughestest Monster",20,200,"Sir Jones","Aston",1200000,0},          //19,
    {"Wanted: Occult Staff",30,200,"Carlos","Aston",4000000,QLF_REPEATABLE},       //20,
    {"Slay the Swampbeast",23,200,"Clara","Swamp",2250000,0},              //21,
    {"Impish Bear Hunt",20,200,"William/Imp","Forest",1250000,0},          //22,
    {"Praying Mantis Stew",20,200,"William","Forest",1500000,0},           //23,
    {"The Spider Queen",25,200,"Hermit","Forest",2500000,0},               //24,
    {"Earning the Lockpick",25,200,"Guildmaster","Exkordon",0,QLF_XREPEAT},      //25, exp awarded in driver, amount depends on robbers killed. range: 5000 to 20000
    {"Extortion",25,200,"Guildmaster","Exkordon",0,QLF_XREPEAT},         //26, exp awarded in driver, 5000 or 10000
    {"Price Fix Exposed",25,200,"Guildmaster","Exkordon",1500000,QLF_XREPEAT},     //27,
    {"The Golden Lockpick",26,200,"Guildmaster","Exkordon",1500000,QLF_XREPEAT},   //28,
    {"Dirty Hands",26,200,"Sanwyn","Exkordon",0,0},                  //29, exp awarded in driver, 45000 total
    {"The Old Governor's Cross",33,200,"Skeleton","Exkordon",3000000,QLF_REPEATABLE},  //30,
    {"Spider Poison",30,200,"Cervik","Exkordon",3000000,QLF_REPEATABLE},       //31,
    {"Join the Tribe",63,200,"Kalanur","Nomad Plains",1000000,0},          //32,
    {"Searching Sarkilar",63,200,"Kir Laas","Nomad Plains",45000000,0},        //33,
    {"A Golden Statue",72,200,"Kir Garan","Nomad Plains",28000000,0},          //34,
    {"Smuggler Book",10,200,"Imp. Commander","Below Aston 2",100000,QLF_REPEATABLE},   //35,
    {"Contraband",10,200,"Imp. Commander","Below Aston 2",0,0},          //36, exp awarded in driver, 5000 total
    {"Smuggler Leader",10,200,"Imp. Commander","Below Aston 2",200000,QLF_REPEATABLE}, //37,
    {"The Family Heirloom",32,200,"Aristocrat","Bran. Forest",4000000,QLF_REPEATABLE}, //38,
    {"Bear Hunt - Again",32,200,"Yoatin","Bran. Forest",4000000,QLF_REPEATABLE},   //39,
    {"The Jewels of Brannington ",34,200,"Count B.","Brannington",0,QLF_REPEATABLE}, //40, exp awarded in driver, 120k total
    {"A Grolm's Spoils",33,200,"Brenneth","Brannington",1500000,QLF_REPEATABLE},   //41,
    {"A Thief's Loot ",33,200,"Brenneth","Brannington",1500000,QLF_REPEATABLE},    //42,
    {"A Necromancer's Notes",33,200,"Brenneth","Brannington",1500000,QLF_REPEATABLE},  //43,
    {"A Rest Disturbed",36,200,"Spirit","Brannington",6000000,QLF_REPEATABLE},     //44,
    {"Searching a Miner's Tool",42,200,"Broklin","Brannington",6000000,QLF_REPEATABLE}, //45,
    {"A Miner's Vengeance",44,200,"Broklin","Brannington",6000000,0},          //46,
    {"A Miner's Misery",85,200,"Dwarven Chief","Grimroot",28500000,0},         //47,
    {"A Miner's Bane",95,200,"Dwarven Chief","Grimroot",39500000,0},          //48,
    {"A Miner's Anguish",105,200,"Dwarven Chief","Grimroot",52500000,0},      //49,
    {"A Miner Lost",115,200,"Dwarven Chief","Grimroot",68000000,0},           //50,
    {"Lizard's Teeth",95,200,"Dwarven Shaman","Grimroot",39500000,0},         //51,
    {"Collecting Berries",100,200,"Dwarven Shaman","Grimroot",45500000,0},        //52,
    {"Elitist Head",105,200,"Dwarven Shaman","Grimroot",52500000,0},          //53,
    {"Looking for Caligar",55,200,"Kelly","Aston",8000000,0},              //54,
    {"Fighting Styles",55,200,"Glori","Caligar",8000000,0},                //55,
    {"Obelisk Hunt",55,200,"Glori","Caligar",8000000,0},               //56,
    {"Find the Keyparts",55,200,"Glori","Caligar",8000000,0},              //57,
    {"Assemble the Key",55,200,"Glori","Caligar",8000000,0},               //58,
    {"Amazon Invaders",55,200,"Homdem","Caligar",8000000,0},               //59,
    {"The Emperor's Plaque",55,200,"Kelly","Aston",24000000,0},            //60,

    {"The Imperial Vault",26,200,"Carlos","Aston",2000000,0},              //61,
    {"Tunnel Magics",26,200,"Rouven","Imperial Vault",1000000,0},          //62,
    {"Chronicles of Seyan",26,200,"Rouven","Imperial Vault",1000000,0},        //63,

    {"Finding Arkhata",47,200,"Guard","Brannington",6000000,0},            //64,
    {"Rammy's Crown",48,200,"Rammy","Arkhata",6000000,0},              //65,
    {"Ishtar's Bracelet",49,200,"Jaz","Arkhata",6000000,0},                //66,
    {"Queen Fiona's Ring",50,200,"Queen Fiona","Arkhata",6000000,0},           //67,
    {"A Shopkeeper's Fright",51,200,"Ramin","Arkhata",6000000,0},          //68,
    {"The Monks' Request",52,200,"Johnatan","Arkhata",6000000,0},          //69,
    {"The Book Eater",53,200,"Tracy","Arkhata",6000000,0},             //70,
    {"Entrance Passes",54,200,"Rammy","Arkhata",9000000,0},                //71,
    {"The Source",60,200,"Jada","Arkhata",12000000,0},                 //72,
    {"Ceremonial Pot",48,200,"Pot Maker","Arkhata",6000000,0},             //73,
    {"The Lost Secrets",49,200,"Thai Pan","Arkhata",6000000,0},            //74,
    {"A Kidnapped Student",53,200,"Trainer","Arkhata",6000000,0},          //75,
    {"The Traitors",53,200,"Clerk","Arkhata",6000000,0},               //76,
    {"The Blue Harpy",58,200,"Hunter","Arkhata",6000000,0},                //77,
    {"The Mysterious Language",60,200,"Johnatan","Arkhata",6000000,0},         //78,
